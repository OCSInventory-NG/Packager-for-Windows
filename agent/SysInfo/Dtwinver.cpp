...
BOOL COSVersion::IsVistaPersonal(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && ((lpVersionInformation->dwSuiteMask & COSVERSION_SUITE_PERSONAL) != 0);
}

BOOL COSVersion::IsVistaProfessional(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && (lpVersionInformation->OSType == Workstation) && !IsVistaPersonal(lpVersionInformation);
}

BOOL COSVersion::IsWebWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && ((lpVersionInformation->dwSuiteMask & COSVERSION_SUITE_WEBEDITION) != 0);
}

BOOL COSVersion::IsWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && (lpVersionInformation->OSType == Server);
}

BOOL COSVersion::IsEnterpriseWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && ((lpVersionInformation->dwSuiteMask & COSVERSION_SUITE_ENTERPRISE) != 0);
}

BOOL COSVersion::IsDatacenterWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && ((lpVersionInformation->dwSuiteMask & COSVERSION_SUITE_DATACENTER) != 0);
}

BOOL COSVersion::IsDomainControllerWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation)
{
  return IsWindowsVista(lpVersionInformation) && (lpVersionInformation->OSType == DomainController);
}
