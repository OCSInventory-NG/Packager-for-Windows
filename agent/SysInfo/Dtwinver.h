...
//functions are not completely mutually exlusive
  ...
  BOOL IsVistaPersonal(LPOS_VERSION_INFO lpVersionInformation);
  BOOL IsVistaProfessional(LPOS_VERSION_INFO lpVersionInformation);
  BOOL IsWebWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation);
  BOOL IsWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation);
  BOOL IsEnterpriseWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation);
  BOOL IsDatacenterWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation);
  BOOL IsDomainControllerWindowsVistaServer(LPOS_VERSION_INFO lpVersionInformation);
